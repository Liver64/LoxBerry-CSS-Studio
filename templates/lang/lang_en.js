...
window.LBDesignStudioLangs.en = {
  ...
  "messages": {
    ...
    "protectedPackageTheme": "Not saved: {theme} is a protected package theme. Use a different display name so that no Liquid Glass CSS or JSON is overwritten accidentally.",
